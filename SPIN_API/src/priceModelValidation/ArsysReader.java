...
public class ArsysReader {
	...
	public static void main(String[] args)
	{
		...
		try {
			jmodel = LinkedUSDLModelFactory.createFromModel("./DebuggingFiles/arsys.ttl");//read a generic model
			...
			jmodel.setBaseURI("http://PricingAPIArsysInstance.com");
