...
public class CloudSigmaReader {
	...
	public static void main(String[] args)
	{
		...
		try {
			jmodel = LinkedUSDLModelFactory.createFromModel("./DebuggingFiles/CloudSigmaRS.ttl");//read a generic model
			...
			jmodel.setBaseURI("http://PricingAPICloudSigmaInstance.com");
